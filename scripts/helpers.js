...
function win(dt=5) {
  reset("wack")
  let str = ""
  play(str, dt)
}
function win2(dt=5) {
  reset("wack")
  let str = ""
  play(str, dt)
}
function winKill(dt=50) {
  reset("kill")
  const str = ""
  play(str, dt)
}
