...
function win(dt=5, bonus=false) {
  reset()
  let str = ""
  str += "01033330000000302110332300330011112333111033332222110122222221211111300112233333322233300103311132111111112210001111112221222222221111111011111122221222222221111111011111122212220034422222112111111"
  str += "01133233333330000000030332211012222222211111110111111221103333332230000000333"
  if (bonus) {
    str = ""
  }
  play(str, dt)
}
