...
function autowin(dt=5) {
  // hmmm undo is currently broken i think
  reset()
  const winStr = "01033330000000302110332300330011112333111033332222110122222221211111300112233333322233300103311132111111112210001111112221222222221111111011111122221222222221111111011111122212220034422222112111111"
  play(winStr, dt)
}
function boring() {
