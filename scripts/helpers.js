...
const solutions = {
  ...
  bubbles: {
    win: "00333330332330122221233333233033333333330111011001112222310011222233330300123211001112211222112333333333311110012110000333223333030011011111003001000000000000011111001003000000000000301111100300100000000003",
    bonus: "",
    // "cheese" now that orange is gone. doesn't seem like a big deal IMO?
    // cheese: "",
    wip: 1,
  },
  dolphin: {
  ...
  packaging: {
    win: "",
    // avoids the unpack/repack in black by putting brown in yellow
    cheese: "",
    wip: 1,
  },
  froot: {
